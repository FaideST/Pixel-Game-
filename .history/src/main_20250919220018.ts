...
const enemies =  [
  ...
  {img: new Image(), x: 550, y: 160, w: 32, h: 32},
];

enemies[0]!.img.src = "assets/sprites/enemies/minispider.png";
enemies[1]!.img.src = "assets/sprites/enemies/Ghost.png";
enemies[2].img.onload = () => console.log("Dead Skelet loaded!");
enemies[2].img.onerror = () => console.error("Failed to load Dead Skelet:", enemies[2].img.src);
...
//Bilder (items)
const items =  [
  {img: new Image(), x: 505, y: 0, w: 32, h: 32},
