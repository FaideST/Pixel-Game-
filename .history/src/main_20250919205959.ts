...
//Bosse / Posi + Laden const UI = { img: new Image (), offsetX: -20, offsetY: 0, w: 24, h: 24, }; UI.img.src = "assets/sprites/ui/gui.png"; const pet = { img: new Image (), offsetX: -20, offsetY: 0, w: 24, h: 24, }; pet.img.src = "assets/sprites/pet/Pat.png"; //Bilder (Bosse) const bosses = [ { img: new Image(), x: 520, y: 128, w: 64, h: 64 }, { img: new Image(), x: 580, y: 112, w: 64, h: 64 }, ]; bosses[0].img.src = "assets/sprites/bosse/CursedKnight.png"; bosses[1].img.src = "assets/sprites/bosse/Bossspider.png"; //Bilder (items) const items = [ { img: new Image(), x: 490, y: 0, w: 32, h: 32 }, { img: new Image(), x: 470, y: 0, w: 32, h: 32 }, ] items[0].img.src = "assets/sprites/items/CursedChest.png"; items[1].img.src = "assets/sprites/items/CursedKey.png"; //Bilder (enemies) const enemies = [ { img: new Image(), x: 580, y: 170, w: 32, h: 32 }, { img: new Image(), x: 600, y: 160, w: 32, h: 32 }, ] enemies[0].img.src = "assets/sprites/enemies/minispider.png"; enemies[1].img.src = "assets/sprites/enemies/Ghost.png"; //Bilder (npcs) const npcs = [ {img: new Image(), x: 100, y: 0, w: 32, h: 32}, ] npcs[0].img.src ="assets/sprites/npcs/Doktor.png";
